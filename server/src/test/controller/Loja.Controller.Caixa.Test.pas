...
begin
  ...
  do begin
    LFechamento.MeiosPagto.Add(TLojaModelDtoRespCaixaResumoCaixaMeioPagto.Create);
    LFechamento.MeiosPagto.Last.CodMeioPagto := LMeioPagto;
    LFechamento.MeiosPagto.Last.VrTotal := 0;
  end;
